...
class NonNegSumOne(Constraint):
    '''Enforces all weight elements to be non-0 and each column/row to be summed to 1'''
...
class ConditionPlusTrain:
    ...
    def __init__(self,label):
        ...
        c_1_condition = Dense(self.sub_classes, activation=None, use_bias=False, kernel_constraint=NonNegSumOne(),kernel_initializer=Zeros(),name='c_1_condition')(input_master)
        c_1_condition = Dense(self.sub_classes, activation='relu', name='c_1_condition_dense_1')(c_1_condition)
        c_1_condition = Dense(self.sub_classes, activation='relu', name='c_1_condition_dense_2')(c_1_condition)
        ...
        c_2_condition = Dense(self.art_classes, activation=None, use_bias=False, kernel_constraint=NonNegSumOne(),kernel_initializer=Zeros(),name='c_2_condition')(input_sub)
        c_2_condition = Dense(self.art_classes, activation='relu', name='c_2_condition_dense_1')(c_2_condition)
        c_2_condition = Dense(self.art_classes, activation='relu', name='c_2_condition_dense_2')(c_2_condition)
...
class ConditionPlusTest:
    ...
    def __init__(self,label):
        ...
        #--- masterCategory conditioning for subCategory branch ---
        c_1_condition = Dense(self.sub_classes, activation=None, use_bias=False, kernel_constraint=NonNegSumOne(),name='c_1_condition')(c_1_pred)
        c_1_condition = Dense(self.sub_classes, activation='relu', name='c_1_condition_dense_1')(c_1_condition)
        c_1_condition = Dense(self.sub_classes, activation='relu', name='c_1_condition_dense_2')(c_1_condition)
        c_2_raw = Dense(self.sub_classes, activation='relu', name='c_2_raw')(c_2_bch)
        preds_features = Add()([c_1_condition,c_2_raw])
        ...
        #--- subCategory conditioning  for articleType branch ---
        c_2_condition = Dense(self.art_classes, activation=None, use_bias=False, kernel_constraint=NonNegSumOne(),kernel_initializer=Zeros(),name='c_2_condition')(c_2_pred)
        c_2_condition = Dense(self.art_classes, activation='relu', name='c_2_condition_dense_1')(c_2_condition)
        c_2_condition = Dense(self.art_classes, activation='relu', name='c_2_condition_dense_2')(c_2_condition)
        c_3_raw = Dense(self.art_classes, activation='relu', name='c_3_raw')(y)
        preds_features = Add()([c_2_condition,c_3_raw])
